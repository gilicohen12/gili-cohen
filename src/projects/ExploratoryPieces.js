      ...
      <div className='page'>
        ...
        <div className='pieces'>
          <ProjectCard
            ...
            projectSummary="A social media web crawler and scraper that can gather large amounts of data from a desired website. Designed a parser to process webpage data and allow the web crawler to not resist previously visited websites."
